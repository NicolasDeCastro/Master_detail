		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "NovoApp",
									"targetURL": "#nicoapptestenovoapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nicoapptestenovoapp-display": {
								"semanticObject": "nicoapptestenovoapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=nico.app.testenovoapp",
									"url": sap.ui.require.toUrl("nico/app/testenovoapp")
								}
							}
						}
					}
